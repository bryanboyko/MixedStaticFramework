...
@property (nonatomic, unsafe_unretained) MaxVASTViewController *player;
...
@implementation MaxVASTControls

- (id)initWithVASTPlayer:(MaxVASTViewController *)vastPlayer
{
...
-(void)toggleToPlayButton:(BOOL)toggleToPlay
{
    @synchronized (self) {
        ...
        if (toggleToPlay) {  // show play button
            ...
            [MaxCommonLogger debug:@"VAST-Toolbar" withMessage:@"Toggle to playButton visible"];
            ...
            [MaxCommonLogger debug:@"VAST-Toolbar" withMessage:@"Toggle to pauseButton visible"];
        }
        [controlsToolbar setItems:toolbarButtons animated:NO];
    }
}
