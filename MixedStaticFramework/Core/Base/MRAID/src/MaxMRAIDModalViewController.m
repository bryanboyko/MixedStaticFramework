...
@implementation MaxMRAIDModalViewController
...
- (id)initWithOrientationProperties:(MaxMRAIDOrientationProperties *)orientationProps
{
    self = [super init];
    if (self) {
...
- (BOOL)shouldAutorotate
{
    ...
    [MaxCommonLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat: @"%@ %@ %@", [self.class description], NSStringFromSelector(_cmd), (retval ? @"YES" : @"NO")]];
    return retval;
}

- (UIInterfaceOrientation)preferredInterfaceOrientationForPresentation
{
    [MaxCommonLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat: @"%@ %@ %@",
...
- (void)forceToOrientation:(MaxMRAIDOrientationProperties *)orientationProps;
{
    ...
    [MaxCommonLogger debug:@"MRAID - ModalViewController" withMessage:[NSString stringWithFormat:@"requesting from %@ to %@",
