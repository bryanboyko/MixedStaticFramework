...
- (MaxVASTError)parseRecursivelyWithData:(NSData *)vastData depth:(int)depth
{
    ...
    [MaxCommonLogger debug:@"VAST-Parser" withMessage:[NSString stringWithFormat:@"VAST file\n%@", content]];
    ...
    if (kValidateWithSchema) {
        [MaxCommonLogger debug:@"VAST-Parser" withMessage:@"Validating against schema"];
