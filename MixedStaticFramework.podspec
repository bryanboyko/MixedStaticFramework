https://github.com/bryanboyko/NVMDummyTestPod
d::Spec.new do |s| 
  s.name             = "NVMDummy" 
  s.version          = "2.0.0" 
  s.summary          = "Testing mixing objc and swift code in a static framework" 
  s.description      = <<-DESC 
  This project is simply for testing mixing objc and swift code in a static framework generated by cocoapods. 
  DESC 
